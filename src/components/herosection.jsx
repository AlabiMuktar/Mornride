...
function Herosection() {
  return (
    <div className='w-full block md:flex bg-gradient-to-b from-black via-gray-900 to-black text-white px-6 md:px-[6rem]'>
      <div className='pt-[2rem] md:pt-[6rem]'>
        ...
        <div>
        <img src={require("../images_1/Marcus bike.png")} className='block mt-[-4rem] md:hidden w-[80%] overflow-hidden' alt="/" />
      </div>  
        <p className='mt-2 md:mt-6 leading-6'>Get your unique bicycle style with our various collections.<br /> Our finale A5 Black are available while stock fasts.</p>
      ...
      <div>
        <img src={require("../images_1/Marcus bike.png")} className='mt-[-6rem] hidden md:block w-[80%]' alt="" />
      </div>  
    </div>
  )
}
